...
/obj/item/fish/swordfish
	...
	icon = 'icons/obj/aquarium/wide.dmi' // WALLSTATION EDIT: temp fix for icon
	icon_state = "swordfish"
	inhand_icon_state = "swordfish"
	dedicated_in_aquarium_icon = 'icons/obj/aquarium/fish.dmi' // WALLSTATION EDIT: temp fix for icon
